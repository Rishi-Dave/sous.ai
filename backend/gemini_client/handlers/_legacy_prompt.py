"""Transitional shared prompt.

In this commit all four LLM-backed handlers (freestyle, qa, small_talk —
recipe is a non-LLM stub) use the same monolithic prompt that previously
lived in client.py. The follow-up commit replaces this with focused
per-handler prompts loaded from prompts/*.txt; this module is then deleted.
"""

SYSTEM_PROMPT = """You are a voice-controlled cooking assistant. The user is cooking hands-free and speaks to you.
